...
public class RobotContainer {
 ...
 // - half speed
 // - 64 LEDs
 RainbowAnimation rainbowAnim = new RainbowAnimation(1, 0.5, 300);
 FireAnimation fireAnimation = new FireAnimation(1, 0.25, 300, 1, 0 );
 RgbFadeAnimation rgbFadeAnimation = new RgbFadeAnimation(1, 0.25, 300 );
