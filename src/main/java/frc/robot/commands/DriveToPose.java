...
public class DriveToPose extends Command {
  ...
  PIDController xController = new PIDController(4.2, 0.1, 0.35);
  PIDController yController = new PIDController(4.2, 0.1, 0.35);
  ProfiledPIDController angleController =
      new ProfiledPIDController(2.5, 0.0, 0.1, AutoConstants.ANGLE_CONSTRAINTS);
