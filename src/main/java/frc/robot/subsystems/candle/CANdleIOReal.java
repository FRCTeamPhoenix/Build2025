...
public class CANdleIOReal implements CANdleIO {
  ...
  private LarsonAnimation blueLarsonAnimation =
      new LarsonAnimation(0, 0, 255, 0, 0.02, 37, BounceMode.Front, 10, 8);
  private LarsonAnimation redLarsonAnimation =
      new LarsonAnimation(255, 0, 0, 0, 0.02, 37, BounceMode.Front, 10, 8);
  private LarsonAnimation orangeLarsonAnimation =
      new LarsonAnimation(255, 30, 0, 0, 0.02, 37, BounceMode.Front, 10, 8);
