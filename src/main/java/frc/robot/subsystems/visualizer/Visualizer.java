...
public class Visualizer extends SubsystemBase {
    ...
    private double clawSetpoint = Math.PI / 8;
    private boolean clawGoingUp = true;
    ...
    public void periodic() {
        ...
        Pose3d tunable = new Pose3d(x.get(), y.get(), z.get(), new Rotation3d(roll.get(), pitch.get(), yaw.get()));   
        ...
        Pose3d claw = new Pose3d(0.178779, 0, height + 0.235 + 0.070668 + (height / elevatorExtension * 0.5), new Rotation3d(0, clawSetpoint, 0)); 
        ...
        Pose3d climber = new Pose3d(0, 0.276527, 0.417863 + 0.070668, new Rotation3d(climberSetpoint, 0, 0)); 
