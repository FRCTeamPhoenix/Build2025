...
public class Elevator extends SubsystemBase {
  ...
  public Elevator(ElevatorIO io) {
    ...
    switch (Constants.CURRENT_MODE) {
      ...
      case SIM:
        pidController =
            new ProfiledPIDController(1.5, 0.50, 1, new TrapezoidProfile.Constraints(3, 3));
        kG = 0.4;
        break;
      default:
        pidController =
  ...
  public void goToPosition(IntSupplier positionIndex) {
    this.setpoint =
        SuperstructureConstants.ELEVATOR_HEIGHTS[
            MathUtil.clamp(
                positionIndex.getAsInt(), 0, SuperstructureConstants.ELEVATOR_HEIGHTS.length - 1)];
  }
